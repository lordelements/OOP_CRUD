          ...
          <footer class="footer">
            <div class="footer-inner-wraper">
              <div class="d-sm-flex justify-content-center justify-content-sm-between py-2">
                ...
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="https://www.elemento.com/" target="_blank">elemento.com </a>2023</span>
              </div>
            </div>
          </footer>
          <!-- partial -->
